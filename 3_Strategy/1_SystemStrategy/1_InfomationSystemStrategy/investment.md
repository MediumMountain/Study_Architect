...
## IT投資ポートフォリオ
- ポートフォリオぽ分析の考え方を情報化投資戦略に応用したもの
- 企業などが情報システムなどIT関連の投資を行う際に、対象をその特性によっていくつかの種類に分類し、企業戦略などに沿って資金など投下する経営資源の配分を調整する手法。
    - 金融の分野で、投資対象をその特性によって分類し、投資額の配分を調整することでリスクとリターンのバランスを調整する「ポートフォリオ理論」をIT投資に応用したもの

- IT投資をその目的やリスクの特性ごとにカテゴライズし、そのカテゴリごとに投資割合を管理することで限りある経営資源を有効に配分することを目的とする
