...
## 業務処理統制(Information Technology Application Control)
- ITを使用する業務が正確に処理されて記録されるための業務運用のルール
    - 内部統制に含まれるIT統制の一部で、業務を管理するシステムにおいて承認された業務がすべて正確に処理・記録されることを担保するために業務プロセスに組み込まれた仕組み
